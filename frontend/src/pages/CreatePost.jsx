			...
			<form className='mt-16 w-full' onSubmit={handleSubmit}>
				<div className='flex flex-col lg:flex-row gap-5 w-full'>
					...
					<div className='lg:w-1/2'>
						<div className='lg:w-full lg:h-auto lg:aspect-square w-full relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 h-54 flex justify-center items-center'>
							{form.photo ? (
